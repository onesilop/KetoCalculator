         ...
         migrationBuilder.CreateTable(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecipeUser = table.Column<Guid>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecipeName = table.Column<string>(maxLength: 100, nullable: false),
                    RecipeMethod = table.Column<string>(nullable: true),
                    RecipeUser = table.Column<Guid>(nullable: true),
                    Calories = table.Column<decimal>(type: "decimal(18, 2)", nullable: false),
                    Ratio = table.Column<decimal>(type: "decimal(18, 2)", nullable: false),
                    UpdateDateTime = table.Column<DateTime>(type: "datetime2(0)", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoalDate = table.Column<DateTime>(type: "datetime2(0)", nullable: false),
                    GoalCalories = table.Column<decimal>(type: "numeric(18, 0)", nullable: false),
                    GoalRatio = table.Column<decimal>(type: "numeric(18, 2)", nullable: false),
                    RecipeType = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DayRecipeFood_FoodStuff",
                        column: x => x.FoodID,
                        principalTable: "FoodStuff",
                        principalColumn: "FoodID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DayRecipeFood_DayRecipes",
                        columns: x => new { x.RecipeID, x.RecipeDate },
                        principalTable: "DayRecipes",
                        principalColumns: new[] { "RecipeID", "RecipeDate" },
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DayRecipeFood_FoodID",
                table: "DayRecipeFood",
                column: "FoodID");

            migrationBuilder.CreateIndex(
                name: "IX_DayRecipeFood_RecipeID_RecipeDate",
                table: "DayRecipeFood",
                columns: new[] { "RecipeID", "RecipeDate" });
